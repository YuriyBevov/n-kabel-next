...
exports.start = series(clean, fonts, isPugEnabled ? pug : html, styles,  sprite, images, toWebp, svg, server);
exports.build = series(toProd, clean, fonts, isPugEnabled ? pug : html, styles,  sprite, images, toWebp, svg);
exports.buildMinAll = series(htmlMinify, toProd, clean, fonts, isPugEnabled ? pug : html, styles,  sprite, images, toWebp, svg);
